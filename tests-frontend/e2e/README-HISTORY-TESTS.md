...
- `/home/mark/repos/personality/tests-frontend/e2e/history.e2e.ts`
...
npm run test:e2e tests-frontend/e2e/history.e2e.ts

# Run specific test group
npm run test:e2e tests-frontend/e2e/history.e2e.ts -g "Empty State"

# Run in headed mode (see browser)
npm run test:e2e tests-frontend/e2e/history.e2e.ts -- --headed

# Run with debug
npm run test:e2e tests-frontend/e2e/history.e2e.ts -- --debug
```
