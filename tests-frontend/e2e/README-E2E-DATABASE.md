...
This project uses a separate PostgreSQL database for end-to-end (e2e) tests to avoid polluting the main development
database.
...
- `DB_DATABASE=bettrprompt_e2e` (not `bettrprompt`)
...
- Verify `.env.e2e` has `DB_DATABASE=bettrprompt_e2e`
