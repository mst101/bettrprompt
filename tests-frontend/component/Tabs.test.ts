...
describe('Tabs', () => {
    ...
    it('should display numeric badge', () => {
        const tabsWithBadge: Tab[] = [
            { id: 'tab1', label: 'Tab One', badge: 42 },
        ];
    ...
    it('should apply active badge styling on active tab', () => {
        const tabsWithBadge: Tab[] = [
            { id: 'tab1', label: 'Tab One', badge: '5' },
        ];
        ...
        expect(badge.classes()).toContain('bg-indigo-100');
        expect(badge.classes()).toContain('text-indigo-600');
    });

    it('should apply inactive badge styling on inactive tab', () => {
        const tabsWithBadge: Tab[] = [
            { id: 'tab1', label: 'Tab One', badge: '5' },
        ];
