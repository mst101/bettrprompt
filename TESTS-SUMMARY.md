...
### 1. E2E Test Suite
**File:** `/home/mark/repos/personality/tests-frontend/e2e/prompt-optimizer-history.e2e.ts`
...
npm run test:e2e tests-frontend/e2e/prompt-optimizer-history.e2e.ts -g "Sorting"
...
### Frontend
- `/home/mark/repos/personality/resources/js/Pages/PromptOptimizer/History.vue` - History page component
...
### Backend
- `/home/mark/repos/personality/app/Http/Controllers/PromptOptimizerController.php` - History endpoint
- `/home/mark/repos/personality/routes/web.php` - Route definition
- `/home/mark/repos/personality/tests/Feature/PromptOptimizerHistoryTest.php` - Backend tests
