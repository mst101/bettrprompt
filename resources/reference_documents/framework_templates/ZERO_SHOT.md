...
## Zero-Shot Framework Template

**Components**: Direct instruction without examples

**Best For**: translation, factual queries
...
{Direct instruction without examples details}
