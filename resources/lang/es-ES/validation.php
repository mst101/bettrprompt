...
return [
    ...
    */
    ...
    | las líneas. Esto facilita la especificación rápida de una línea
    | de idioma personalizada para una regla de atributo dada.
    |
    */
    ...
    | nuestro marcador de posición de atributo con algo más legible
    | como "Dirección de correo" en lugar de "correo". Esto simplemente
    | nos ayuda a que los mensajes sean un poco más claros.
    |
    */
