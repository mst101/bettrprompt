                ...
                <div class="mt-10 flex justify-center gap-4">
                    ...
                    <template v-else>
                        ...
                        <button
                            ...
                            class="inline-flex items-center justify-center rounded-md border border-indigo-600 bg-white px-6 py-3 text-base font-medium text-indigo-600 shadow-xs transition hover:bg-indigo-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden"
                        >
