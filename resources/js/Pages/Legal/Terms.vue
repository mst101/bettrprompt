    ...
    <ContainerPage>
        <div class="overflow-hidden bg-indigo-50 shadow-xs sm:rounded-lg">
            ...
            >
                ...
                <p>
                    By accessing and using BettrPrompt ("the Service"), operated
                    by
                    {{ COMPANY_INFO.name }} ("we", "us", or "our"), you agree to
                    be bound by these Terms of Use and all applicable laws and
                ...
                <p>
                    ...
                    personality type (as defined by 16personalities.com) and the
                    task you wish to accomplish. The Service uses artificial
                    intelligence to generate, optimise, and save prompts for
                    your use.
                </p>

                <h2>3. Beta/Test Mode Notice</h2>
                <p>
                    The BettrPrompt service is currently in beta/test mode. As a
                    participant in this testing phase, you acknowledge and agree
                    that:
                </p>
                <ul>
                    <li>
                        <strong>Data Usage for Improvement:</strong> Any data
                        you choose to enter into the system may be used by us to
                        understand user behaviour, improve the system's
                        functionality, and enhance the quality of responses. We
                        use this data solely for the purpose of developing and
                        refining BettrPrompt.
                    </li>
                    <li>
                        ...
                        passwords, financial information, health data, personal
                        identification numbers, or trade secrets. We cannot
                        guarantee the same level of security and privacy that a
                        fully released service would provide.
                    </li>
                    <li>
                        <strong>Data Retention and Deletion:</strong> All data
                        entered during the beta testing phase will be
                        permanently deleted on 31st January 2026. No data from
                        this testing period will be retained after this date.
                    </li>
                    <li>
                        <strong>Free Access Period:</strong> In exchange for
                        your participation in beta testing, you are granted free
                        access to use the BettrPrompt service without limitation
                ...
                <p>
                    ...
                    any information provided proves to be inaccurate, false, or
                    misleading.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        Generate prompts for illegal, harmful, or malicious
                        purposes
                    </li>
                    <li>
                    ...
                    <li>
                        Use the Service for any automated or systematic data
                        collection
                    </li>
                </ul>
                ...
                <p>
                    ...
                    functionality, is owned by
                    {{ COMPANY_INFO.name }} and is protected by international
                    copyright, trademark, and other intellectual property laws.
                </p>
                <p>
                    You retain ownership of the prompts and content you create
                    using the Service. By using the Service, you grant us a
                    licence to use, store, and process your prompts solely for
                ...
                <ul>
                    <li>
                        <strong>16personalities.com:</strong> For personality
                        type classification
                    </li>
                    <li>
                        <strong>Anthropic (Claude API):</strong> For AI-powered
                        prompt generation and optimisation
                    </li>
                    <li>
                        <strong>OpenAI (Whisper API):</strong> For
                    ...
                    <li>
                        <strong>Analytics services:</strong> For service
                        improvement and usage tracking
                    </li>
                </ul>
                <p>
                    Your use of these third-party services is subject to their
                    respective terms of service and privacy policies. We are not
                    responsible for the practices or content of third-party
                    services.
                </p>

                <h2>8. Paid Features and Billing</h2>
                <p>
                    Certain features of the Service may be provided for a fee.
                    You agree to pay all fees associated with your use of paid
                    features. All fees are non-refundable unless otherwise
                    stated or required by law.
                </p>
                <p>
                    We reserve the right to change our fees at any time with
                    reasonable notice. Continued use of paid features after a
                    fee change constitutes acceptance of the new fees.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        The quality of any prompts or content will meet your
                        expectations
                    </li>
                ...
                <ul>
                    ...
                    <li>
                        Any bugs, viruses, or other harmful code transmitted
                        through the Service
                    </li>
                    <li>
                ...
                <p>
                    ...
                    {{ COMPANY_INFO.name }}, its officers, directors, employees,
