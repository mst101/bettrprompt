                ...
                <div class="p-6 lg:p-8">
                    ...
                    <div class="prose prose-indigo mt-8 max-w-none prose-headings:scroll-mt-20 prose-h2:mt-8 prose-h2:mb-4 prose-h2:text-2xl prose-h2:font-bold prose-h2:text-gray-900 prose-h3:mt-6 prose-h3:mb-3 prose-h3:text-lg prose-h3:font-semibold prose-p:mb-4 prose-p:leading-relaxed prose-ul:my-4 prose-ul:space-y-2 prose-li:leading-relaxed">
                        ...
                        <ul>
                            ...
                            <li><strong>Personality Information:</strong> Your 16personalities.com personality type and trait percentages</li>
                            <li><strong>Prompt Data:</strong> Tasks you submit and optimised prompts generated for you</li>
                        ...
                        <ul>
                            <li><strong>Google OAuth:</strong> If you use Google sign-in, we receive your name, email address, and profile picture from Google</li>
                            <li><strong>Payment Processors:</strong> If you use paid features, we receive payment confirmation data (but not your payment card details)</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>Generate personalised AI prompts based on your personality type and tasks</li>
                            <li>Authenticate your account and manage your preferences</li>
                        ...
                        <ul>
                            <li><strong>Analytics Services:</strong> We use analytics tools to understand how users interact with the Service. These services may collect anonymised or pseudonymised data.</li>
                        </ul>

                        <h3>6.3 Payment Processors</h3>
                        <ul>
                            <li><strong>Payment Services:</strong> If you purchase paid features, your payment information is processed directly by our payment processor. We do not store your payment card details.</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><strong>Prompt History:</strong> Retained while your account is active, unless you delete specific prompts</li>
                            <li><strong>Log Data:</strong> Typically retained for up to 90 days</li>
                            <li><strong>Legal/Financial Records:</strong> Retained as required by law (e.g., 6-7 years for financial records)</li>
                        </ul>
                        ...
                        <p>
                            Some of our third-party service providers (such as OpenAI) may be located outside the United Kingdom. Where we transfer data internationally, we ensure appropriate safeguards are in place, such as:
                        </p>
                        <ul>
                            <li>Standard Contractual Clauses (SCCs) approved by the UK authorities</li>
                        ...
                        <ul>
                            <li><strong>Essential Cookies:</strong> Required for the Service to function (e.g., session management, authentication)</li>
                        ...
                        <p>
                            With your consent, we may send you marketing emails about new features, updates, and offers. You can opt out at any time by:
                        </p>
                        <ul>
