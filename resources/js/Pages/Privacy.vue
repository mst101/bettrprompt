                ...
                <div class="p-6 lg:p-8">
                    ...
                    >
                        ...
                        <p>
                            ...
                            ensuring compliance with the UK General Data
                        ...
                        <ul>
                            ...
                            <li>
                                <strong>Personality Information:</strong> Your
                                16personalities.com personality type and trait
                                percentages
                            </li>
                            <li>
                                <strong>Prompt Data:</strong> Tasks you submit
                                and optimised prompts generated for you
                            </li>
                            <li>
                                <strong>Profile Information:</strong> Any
                                additional information you choose to add to your
                                profile
                            </li>
                            <li>
                                <strong>Communication Data:</strong> Information
                                you provide when contacting us for support
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <strong>Log Data:</strong> Server logs, error
                                reports, performance data
                            </li>
                            <li>
                                <strong
                                    >Cookies and Similar Technologies:</strong
                                >
                        ...
                        <ul>
                            <li>
                                <strong>Google OAuth:</strong> If you use Google
                                sign-in, we receive your name, email address,
                                and profile picture from Google
                            </li>
                            <li>
                                <strong>Payment Processors:</strong> If you use
                                paid features, we receive payment confirmation
                                data (but not your payment card details)
                            </li>
                        </ul>

                        <h2>4. Legal Basis for Processing</h2>
                        <p>
                            Under UK GDPR, we process your personal data on the
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                improve the Service, prevent fraud, and ensure
                                security
                            </li>
                            <li>
                                <strong>Consent:</strong> For marketing
                                communications and non-essential cookies (where
                                required)
                            </li>
                            <li>
                                <strong>Legal Obligation:</strong> To comply
                        ...
                        <ul>
                            ...
                            <li>
                                Generate personalised AI prompts based on your
                                personality type and tasks
                            </li>
                            <li>
                                Authenticate your account and manage your
                                preferences
                            </li>
                            ...
                            <li>
                                Analyse usage patterns to improve user
                                experience
                            </li>
                            <li>
                        ...
                        <p>
                            We share your data with the following third-party
                            services:
                        </p>

                        <h3>6.1 Essential Service Providers</h3>
                        <ul>
                            <li>
                                <strong>Anthropic (Claude API):</strong> We send
                                your task descriptions and personality
                                information to Anthropic's Claude API to
                                generate optimised prompts. Anthropic's data
                                processing is governed by their
                                <a
                            ...
                            <li>
                                <strong>OpenAI (Whisper API):</strong> When you
                                use voice input features, we send your audio to
                                OpenAI's Whisper API for speech-to-text
                                transcription. OpenAI's data processing is
                                governed by their
                                <a
                            ...
                            <li>
                                <strong>Google OAuth:</strong> For
                                authentication services, subject to Google's
                                <a
                            ...
                            <li>
                                <strong>Hosting Provider:</strong> Our servers
                                and databases are hosted securely with
                                {{ COMPANY_INFO.hostingProvider }}.
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                <strong>Analytics Services:</strong> We use
                                analytics tools to understand how users interact
                                with the Service. These services may collect
                                anonymised or pseudonymised data.
                            </li>
                        </ul>

                        <h3>6.3 Payment Processors</h3>
                        <ul>
                            <li>
                                <strong>Payment Services:</strong> If you
                                purchase paid features, your payment information
                                is processed directly by our payment processor.
                        ...
                        <ul>
                            ...
                            <li>
                                To protect our rights, property, or safety, and
                                that of our users
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <strong>Account Data:</strong> Retained while
                                your account is active and for up to 90 days
                                after deletion
                            </li>
                            <li>
                                <strong>Prompt History:</strong> Retained while
                                your account is active, unless you delete
                                specific prompts
                            </li>
                            <li>
                                <strong>Log Data:</strong> Typically retained
                                for up to 90 days
                            </li>
                            <li>
                                <strong>Legal/Financial Records:</strong>
                                Retained as required by law (e.g., 6-7 years for
                                financial records)
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                Encryption of data in transit (HTTPS/TLS) and at
                                rest
                            </li>
                        ...
                        <p>
                            ...
                            is 100% secure. Whilst we strive to protect your
                            data, we cannot guarantee absolute security.
                        </p>

                        <h2>10. International Data Transfers</h2>
                        <p>
                            Some of our third-party service providers (such as
                            OpenAI) may be located outside the United Kingdom.
                        ...
                        <ul>
                            <li>
                                ...
                                the Service to function (e.g., session
                        ...
                        <p>
                            With your consent, we may send you marketing emails
                            about new features, updates, and offers. You can opt
                            out at any time by:
                        </p>
                        <ul>
                            <li>
                            ...
                            <li>
                                Contacting us at {{ COMPANY_INFO.contactEmail }}
                            </li>
                        </ul>
                        <p>
                            Please note that you will continue to receive
                            essential service-related communications regardless
                        ...
                        <ul>
                            ...
                            <li>
                                Sending an email notification for material
                                changes
                            </li>
                        </ul>
                        <p>
                        ...
                        <p>
                            ...
                            If you are not satisfied with our response, you have
