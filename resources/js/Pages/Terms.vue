            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 lg:p-8">
                    ...
                    <div class="prose prose-indigo mt-8 max-w-none">
                        ...
                        <p>
                            AI Buddy provides an AI-powered prompt optimisation service that creates tailored prompts based on your personality type (as defined by 16personalities.com) and the task you wish to accomplish. The Service uses artificial intelligence to generate, optimise, and save prompts for your use.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>Generate prompts for illegal, harmful, or malicious purposes</li>
                        ...
                        <ul>
                            <li><strong>16personalities.com:</strong> For personality type classification</li>
                            <li><strong>OpenAI API:</strong> For AI-powered prompt generation and optimisation</li>
                            <li><strong>Google OAuth:</strong> For authentication services</li>
                            <li><strong>Analytics services:</strong> For service improvement and usage tracking</li>
                        </ul>
                        <p>
                        ...
                        <p>
                            Certain features of the Service may be provided for a fee. You agree to pay all fees associated with your use of paid features. All fees are non-refundable unless otherwise stated or required by law.
                        </p>
                        <p>
                            We reserve the right to change our fees at any time with reasonable notice. Continued use of paid features after a fee change constitutes acceptance of the new fees.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>The quality of any prompts or content will meet your expectations</li>
