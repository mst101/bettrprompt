                ...
                <div class="p-6 lg:p-8">
                    ...
                    >
                        ...
                        <p>
                            ...
                            personality type (as defined by 16personalities.com)
                            and the task you wish to accomplish. The Service
                            uses artificial intelligence to generate, optimise,
                            and save prompts for your use.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                accept all risks of unauthorised access
                            </li>
                            <li>
                                Notify us immediately of any unauthorised use of
                                your account
                            </li>
                        </ul>
                        <p>
                            We reserve the right to suspend or terminate your
                            account if any information provided proves to be
                        ...
                        <ul>
                            ...
                            <li>
                                Generate prompts for illegal, harmful, or
                                malicious purposes
                            </li>
                            <li>
                            ...
                            <li>
                                Collect or harvest personal information from
                                other users
                            </li>
                            <li>
                                Use the Service for any automated or systematic
                                data collection
                            </li>
                        </ul>
                        ...
                        <p>
                            ...
                            features, and functionality, is owned by
                            {{ COMPANY_INFO.name }} and is protected by
                            international copyright, trademark, and other
                            intellectual property laws.
                        </p>
                        <p>
                            You retain ownership of the prompts and content you
                            create using the Service. By using the Service, you
                            grant us a licence to use, store, and process your
                            prompts solely for the purpose of providing the
                            Service to you.
                        </p>

                        <h2>6. Third-Party Services</h2>
                        <p>
                            The Service integrates with and relies upon
                            third-party services, including:
                        </p>
                        <ul>
                            <li>
                                <strong>16personalities.com:</strong> For
                                personality type classification
                            </li>
                            <li>
                                <strong>Anthropic (Claude API):</strong> For
                                AI-powered prompt generation and optimisation
                            </li>
                            <li>
                        ...
                        <p>
                            ...
                            their respective terms of service and privacy
                        ...
                        <p>
                            Certain features of the Service may be provided for
                            a fee. You agree to pay all fees associated with
                            your use of paid features. All fees are
                            non-refundable unless otherwise stated or required
                            by law.
                        </p>
                        <p>
                            We reserve the right to change our fees at any time
                            with reasonable notice. Continued use of paid
                            features after a fee change constitutes acceptance
                            of the new fees.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>
                                The quality of any prompts or content will meet
                                your expectations
                            </li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                any loss or damage incurred as a result of the
                                use of any content posted, emailed, transmitted,
                        ...
                        <p>
                            ...
                            employees, and agents from any claims, liabilities,
                            damages, losses, and expenses, including reasonable
                            legal fees, arising out of or in any way connected
                            with your access to or use of the Service, or your
                        ...
                        <p>
                            ...
                            page. By continuing to use the Service after changes
