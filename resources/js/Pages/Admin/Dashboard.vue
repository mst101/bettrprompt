...
<template>
    ...
    <ContainerPage>
            ...
            <Card>
                <div class="flex items-center">
                    <div class="rounded-lg bg-green-100 p-3 text-green-600">
                        <DynamicIcon name="clipboard-list" class="h-6 w-6" />
                    </div>
                    <div class="ml-4">
                        <p class="text-xs text-indigo-500 sm:text-sm">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Card class="transition-shadow duration-200 hover:shadow-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-indigo-500">
                                {{ $t('admin.dashboard.links.users.subtitle') }}
                            </p>
                        </div>
                        <DynamicIcon
                            name="chevron-right"
            ...
            <!-- Tasks Link -->
            <Link :href="countryRoute('admin.tasks.index')">
                <Card class="transition-shadow duration-200 hover:shadow-lg">
                    <div class="flex items-center">
                        <DynamicIcon
                            name="clipboard-list"
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-indigo-500">
                                {{ $t('admin.dashboard.links.tasks.subtitle') }}
                            </p>
                        </div>
                        <DynamicIcon
                            name="chevron-right"
