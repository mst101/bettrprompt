...
<template>
    ...
    <ContainerPage>
        ...
        <Card class="max-w-4xl">
            ...
            >
                <h3 class="mb-4 font-semibold text-indigo-900">New Variant</h3>
                <form class="space-y-4" @submit.prevent="addVariant">
                    ...
                    <div class="flex gap-2 border-t border-indigo-200 pt-4">
                        ...
                        <ButtonSecondary @click="showAddVariantForm = false">
                            Cancel
                        </ButtonSecondary>
                    </div>
                </form>
            ...
            <div class="space-y-3">
                ...
                >
                    <p class="text-sm text-indigo-700">
                        No personality variants yet. Add one to provide adjusted
                        phrasings.
                    </p>
                </div>
            </div>
