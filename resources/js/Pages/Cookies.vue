                ...
                <div class="p-6 lg:p-8">
                    ...
                    >
                        ...
                        <p>
                            ...
                            device (computer, smartphone, or tablet) when you
                            visit a website. They are widely used to make
                            websites work more efficiently and provide
                            information to website owners.
                        </p>
                        <p>
                            Cookies allow websites to remember your actions and
                            preferences (such as login details, language
                            selection, and other display preferences) over a
                            period of time, so you don't have to keep
                            re-entering them whenever you return to the site or
                            browse from one page to another.
                        </p>

                        <h2>2. How We Use Cookies</h2>
                        <p>{{ COMPANY_INFO.name }} uses cookies to:</p>
                        <ul>
                            <li>Keep you signed in to your account</li>
                            <li>Remember your preferences and settings</li>
                            <li>Protect against security threats and abuse</li>
                            <li>
                                Understand how you use our Service to improve it
                            </li>
                        ...
                        <p>
                            We categorise cookies based on their purpose and
                            provide you with control over non-essential cookies.
                        </p>
                        ...
                        <p>
                            Some cookies are placed by third-party services that
                            appear on our pages:
                        </p>
                        <ul>
                            <li>
                                <strong>Google OAuth:</strong> When you use
                                Google sign-in, Google may set cookies according
                        ...
                        <p>
                            ...
                            check the relevant third-party websites for more
                        ...
                        <p>
                            ...
                            reject cookies (except essential cookies, which are
                            necessary for the Service to function).
                        </p>

                        <h3>5.1 Cookie Banner</h3>
                        <p>
                            When you first visit our Service, you will see a
                            cookie banner allowing you to:
                        </p>
                        <ul>
                            <li>
                                <strong>Accept All:</strong> Consent to all
                                cookies
                            </li>
                            <li>
                                <strong>Reject All:</strong> Reject all
                                non-essential cookies
                            </li>
                            <li>
                                <strong>Customise:</strong> Choose which
                        ...
                        <p>
                            ...
                            of any page. This will open a modal where you can
                        ...
                        <p>
                            ...
                            through their settings preferences. However, if you
                            limit the ability of websites to set cookies, you
                            may worsen your overall user experience, as some
                            features may no longer function properly.
                        </p>
                        <p>
                            To find out more about cookies, including how to see
                            what cookies have been set and how to manage and
                            delete them, visit:
                        </p>
                        <ul>
                            <li>
                        ...
                        <p>
                            ...
                            feature that signals to websites that you do not
                            want to have your online activity tracked. Our
                            Service currently does not respond to DNT signals.
                        </p>
