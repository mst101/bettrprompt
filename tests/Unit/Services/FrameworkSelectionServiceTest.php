...
beforeEach(function () {
    $this->service = app(FrameworkSelectionService::class);
    $this->user = User::factory()->create();
    $this->visitor = Visitor::factory()->create();
});

describe('Framework Selection Service - Selection Recording', function () {
    test('records framework selection with all required fields', function () {
        ...
        expect($selection)->toBeInstanceOf(FrameworkSelection::class)
    ...
    test('records multiple selections for different prompt runs', function () {
        ...
        expect(FrameworkSelection::count())->toBe(2);
    });
});

describe('Framework Selection Service - Framework Updates', function () {
...
describe('Framework Selection Service - Outcome Tracking', function () {
    ...
    test('updates selection with copy and edit flags', function () {
        ...
        expect($updated->prompt_copied)->toBeTrue()
            ...
            ->and((float) $updated->edit_percentage)->toBe(25.5);
    });
    ...
    test('updates selection with all outcome metrics', function () {
        ...
        expect($updated->prompt_rating)->toBe(5)
            ...
            ->and($updated->prompt_edited)->toBeTrue()
            ->and((float) $updated->edit_percentage)->toBe(10.0);
    });
    ...
    test('preserves existing outcome data when updating one field', function () {
        ...
        expect($updated->prompt_rating)->toBe(3)
            ->and($updated->prompt_copied)->toBeTrue()
            ->and($updated->prompt_edited)->toBeTrue()
            ->and((float) $updated->edit_percentage)->toBe(20.0);
    });
});

describe('Framework Selection Service - Acceptance Rate', function () {
...
describe('Framework Selection Service - Rating Calculations', function () {
...
describe('Framework Selection Service - Copy Rate', function () {
...
describe('Framework Selection Service - Performance Analysis', function () {
...
describe('Framework Selection Service - Data Integrity', function () {
