...
class ModelTypeScriptIndexGenerator
{
    /**
     * Generate an index file that exports all model types.
     *
     * @param  string  $outputDirectory  The directory where model TypeScript files are stored
    ...
    public function generate(string $outputDirectory): string
    {
        ...
        if ($files->isEmpty()) {
            ...
            $content = "// Auto-generated index file for model types\n\n";
            $content .= $exports;
        }
